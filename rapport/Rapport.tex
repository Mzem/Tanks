...
\section{Introduction}
	...
	\subsection{Installation du jeu :}
	...
	\end{description}	
	\subsection{Installation des tests :}
	Se positionner sur le répertoire de tests \lstinline!Tanks/tests! puis :
	\begin{description}
		\item{\textbf{Compilation des tests :}} taper la commande \lstinline!make!.
		\item{\textbf{Lancement des tests :}} taper la commande \lstinline!make run!.
	\end{description}
...
\section{Explication du code}
	...
	\lstinputlisting[firstline=28,lastline=29,title=Menu.cpp]{../src/Menu.cpp}
	...
	\lstinputlisting[firstline=33,lastline=37,title=Menu.cpp]{../src/Menu.cpp}
	...
	La classe \lstinline!Jeu! est la classe fondamentale qui va afficher les éléments du jeu puis gérer les événements. 
		...
		\lstinputlisting[firstline=146,lastline=151,title=Jeu.cpp]{../src/Jeu.cpp}
		...
		\lstinputlisting[firstline=198,lastline=207,title=Jeu.cpp]{../src/Jeu.cpp}
	...
	La classe \lstinline!Tank! permet de construire un tank et gérer les événements liés à son déplacement et le positionnement de son canon et aussi au tir.
		...
		\lstinputlisting[firstline=73,lastline=121,title=Tank.cpp]{../src/Tank.cpp}
		...
		\lstinputlisting[firstline=296,lastline=306,title=Tank.cpp]{../src/Tank.cpp}
	...
	La classe \lstinline!Obus! permet de construire un obus (à la position et à la direction passés en paramètre) et gérer les événements liés à son mouvement et son impact.
		...
		\lstinputlisting[firstline=96,lastline=97,title=Obus.cpp]{../src/Obus.cpp}
		...
		\lstinputlisting[firstline=30,lastline=30,title=Obus.cpp]{../src/Obus.cpp}
		
		\subsubsection{Mouvement}
		Le mouvement de l'obus va être géré dans la méthode \lstinline!bouger()! qui sera appelée toutes les 10 millisecondes.
		\lstinputlisting[firstline=35,lastline=37,title=Obus.cpp]{../src/Obus.cpp}
		...
		\lstinputlisting[firstline=56,lastline=87,title=Obus.cpp]{../src/Obus.cpp}
